package assets;
 ...
 /**
  * Utility class for loading game assets like images, animations, and spritesheets.
  * Provides static methods to load single images, animation frames, and spritesheet frames.
  *
  * <p>Example usage:</p>
  * <pre>
  ...
  * - For spritesheets, frameWidth and frameHeight must be positive integers.
  * - For spritesheets, numFrames must be positive and not exceed available frames.
  *
  * @postConditions:
  * - Successfully loaded images will be returned as BufferedImage objects.
  * - Failed loads will return null for single images or empty lists for animations.
 ...
 public class AssetLoader {
      ...
      */
     public static List<BufferedImage> loadSpritesheetFrames(String fileName, int frameWidth, int frameHeight, int numFrames) {
         List<BufferedImage> frames = new ArrayList<>();
