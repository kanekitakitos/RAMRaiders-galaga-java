package core;
   ...
   * including updating rotation, scaling, and position based on the associated transform.
   * Subclasses must implement specific behavior for scaling, position, and representation.
   *
   * @Pre-Conditions:
