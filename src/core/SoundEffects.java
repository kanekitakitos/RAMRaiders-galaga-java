...
/**
 * The SoundEffects class manages sound effects for a game, allowing for
 * playback, looping,
 * volume control, and resource cleanup. It provides functionality to handle
 * individual
 ...
 *
 * @postConditions:
 *                  - Sound clips are stored and can be played, looped, or
 *                  stopped.
 *                  - Global volume affects all sound clips.
 *                  - Resources are released when dispose() is called.
 *
 * @see <a href=
 *      "https://docs.oracle.com/javase/7/docs/api/javax/sound/sampled/Clip.html">Clip
 *      API</a>
 * @see <a href=
 *      "https://docs.oracle.com/javase/7/docs/api/javax/sound/sampled/FloatControl.html">FloatControl
 *      API</a>
 *
 * @author
 * @version 2025-03-25
