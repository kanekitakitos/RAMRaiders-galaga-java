package core.behaviorItems;
  ...
  * oscillation and descending vertical motion in two phases. Direction is configurable.
  *
  * <p>Phases of movement:</p>
  * <ol>
  *   <li>Phase 1: Sinusoidal horizontal oscillation with a steady vertical descent.</li>
  *   <li>Phase 2: Faster vertical descent with continued sinusoidal oscillation.</li>
  * </ol>
  *
  * <p>Example usage:</p>
  * <pre>
  ...
  * - The direction of movement must be set using the `setDirection` method if needed.
  *
  * @postConditions:
  * - The `GameObject` will follow the defined movement pattern.
  * - The movement will deactivate automatically after completing the defined duration.
  * - The velocity of the `GameObject` will be updated at each step of the movement.
  *
  * @see <a href="https://gamedev.stackexchange.com/questions/82811/implementing-galaga-style-enemy-behavior-in-unity"> Implementing Galaga Style Enemy Behavior </a>
  * @see <a href="https://chatgpt.com/share/68095b69-8cb0-8011-8705-2d3eade4aa69"> How to create a parametric function and what attributes I need to define one - ChatGPT</a>
  *
  * @version 2025-04-23
  */
