package core.behaviorItems;
     ...
     * of an enemy object.
     *
     * <p>Implementations of this interface should provide specific movement patterns
     * for enemy objects and manage their active state. The active state determines
     * whether the enemy is allowed to move or not.</p>
     *
     * <p>Example usage:</p>
     * <pre>
    ...
    {
        /**
         * Moves the specified enemy object according to the implemented movement pattern.
