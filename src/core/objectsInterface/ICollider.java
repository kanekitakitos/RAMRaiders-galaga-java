...
/**
 * The ICollider interface defines the contract for collider components in the
 * game.
 * A collider is responsible for detecting and handling collisions between game
 * objects.
 *
