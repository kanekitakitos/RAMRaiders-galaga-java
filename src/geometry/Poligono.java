package geometry;
	 ...
	 public class Poligono extends Collider implements FiguraGeometrica
	 {
	      ...
	      * @throws IllegalArgumentException if any two points are the same or if the polygon is invalid.
	      */
	     ...
	     */
		  ...
		  * The logical width is determined as the difference between the maximum and minimum x-coordinates
		  ...
		  * The logical height is determined as the difference between the maximum and minimum y-coordinates
		  * of the vertices of the polygon.
		  *
