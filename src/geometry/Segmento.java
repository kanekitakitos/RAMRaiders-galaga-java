package geometry;
     ...
     * Provides methods to calculate properties such as length, check for intersections, and verify geometric relationships.
     *
    ...
    public class Segmento
    {
        ...
        /**
         * Copy constructor that creates a new segment with the same endpoints as the given segment.
         *
