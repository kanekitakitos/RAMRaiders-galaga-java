package gui;
    ...
    /**
     * Handles input events for a player, mapping keyboard and mouse inputs to specific actions.
     ...
     *
     * @preConditions:
     * - Key and mouse maps must be properly initialized with valid mappings.
     *
     * @postConditions:
    ...
    public class HandlerInputPlayer extends InputEvent
    {
        ...
        /**
         * Constructs a HandlerInputPlayer object and initializes key and mouse mappings.
         */
         ...
         * @return The action string associated with the key code, or "UNKNOWN" if not mapped.
         */
         ...
         * @return The action string associated with the mouse button code, or "UNKNOWN" if not mapped.
         */
